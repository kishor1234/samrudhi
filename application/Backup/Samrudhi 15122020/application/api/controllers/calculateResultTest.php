...
class calculateResultTest extends CAaskController {
                                    ...
                                    if (!in_array($nono, $this->blockno)) {
                                        if (!in_array($nono, $lottery)) {
                                            if (strcmp($this->min, "1") == 0) {
                                                if ($this->load[$key][$nono] <= $cpoint) {
                                                    $perPl = $pointPerPlat;
                                                    $cpoint -= $this->load[$key][$nono];
                                                   // echo $nono . " Select CPoint Number<br>";
...
//                          
               ...
               // print_r($lottery);
                ...
                print_r($lottery);
                //print_r($sonaResult);
                echo "<br>Final array Win Amount " . $fcount * ($this->wrate) . "</br>";
                die;
