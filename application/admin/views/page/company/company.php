                                                        ...
                                                        <form action="#" method="post" id="myForm">
                                                            <div class="row form-group">
                                                                <div class="col-lg-6">
                                                                    ...
                                                                    <input type="text" name="company" id="company" placeholder="Enter company name." title="Enter company name" required autocomplete="off" class="form-control">
                                                                    <span id="error_company" class=""></span>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <label class="form-control-label">CIN Number <span class="text-danger">*</span></label>
                                                                    <input type="text" name="cin" id="cin" placeholder="Enter cin number." title="Enter cin number" required autocomplete="off" class="form-control">
                                                                    <span id="error_cin" class=""></span>
                                                                </div>
                                                            </div>
...
<script type="text/javascript">
    ...
    {
        $.post('<?= api_url ?>/?r=CCompany', {id: id, action: 'select'}, function (data) {
            console.log(data);
            var json = JSON.parse(data);
            $("#id").val(json.row["id"]);
            $("#company").val(json.row["company"]);
            $("#address").val(json.row["address"]);
            $("#state").val(json.row["state"]);
            $("#dist").val(json.row["dist"]);
            $("#city").val(json.row["city"]);
            $("#cin").val(json.row["cin"]);
    ...
    function deletebusiness(id, st)
    {
        ...
        function () {
            $.post('<?= api_url ?>/?r=CCompany', {id: id, st: st, action: 'delete'}, function (data) {
                console.log(data);
                table.ajax.reload(null, false);
                var json = JSON.parse(data);
                $.toaster({priority: json.toast[0], title: json.toast[1], message: json.toast[2]});
