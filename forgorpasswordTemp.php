                    ...
                    <tr>
                        <td id="message-body-left-margin" width="0"></td><td id="message-body">
                            <table id="paragraphs" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr><td class="paragraph" style="padding:0 5% 18px;font:300 14px/18px 'Lucida Grande', Lucida Sans, Lucida Sans Unicode, sans-serif, Arial, Helvetica, Verdana, sans-serif;color:#333;">You recently requested for a password reset on <?=domain?> using your email <em style="font-family: 'Lucida Grande Bold', 'Lucida Grande', Lucida Sans, Lucida Sans Unicode, sans-serif, Arial, Helvetica, Verdana, sans-serif;font-style:normal;"><?=$email?></em>. To verify this email address belongs to you and to reset your password, click the link below.</td></tr>
                                <tr><td class="paragraph" style="padding:0 5% 18px;font:300 14px/18px 'Lucida Grande', Lucida Sans, Lucida Sans Unicode, sans-serif, Arial, Helvetica, Verdana, sans-serif;color:#333;"><a href="<?=$shortLink?>" style="line-height:18px;color:#08c;text-decoration:none;" role="link">Reset </a></td></tr>
